...
app.get('',(req,res)=>{
    products.getAllproducts((error,listProducts)=>{     
        if(error){
            return res.send("faltal error")
        }
        const productJson=JSON.parse(listProducts)
        return   res.render('index',{title:'E-commerce',productJson})      
    });
